...
var SympyEditor = (function () {
  ...
  var REPORT_CSS = [
    ...
    "body.slides .slide-on { display: block; margin: auto 0; font-size: 1.35em; }",
  ...
  var PLAYER_JS = [
    ...
    "  if (!bar) return;",
    "  var slides = [].slice.call(document.querySelectorAll('main > section.step, main > .transition'));",
    "  var body = document.body, count = bar.querySelector('.count');",
    "  var play = bar.querySelector('.play'), i = 0, timer = null;",
    "  var STEP_MS = 2200;",
    "  function show(n) {",
    "    i = Math.max(0, Math.min(slides.length - 1, n));",
    "    for (var k = 0; k < slides.length; k++) slides[k].classList.toggle('slide-on', k === i);",
    ...
    "  }",
    "  function exit() { stop(); body.classList.remove('slides');",
    "    for (var k = 0; k < slides.length; k++) slides[k].classList.remove('slide-on'); }",
